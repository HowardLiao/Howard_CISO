...
# Load the multilingual data from build_index_html.py
...
data_block = orig[data_idx:end_idx].strip()
...
<body class="bg-obsidian-950 text-slate-100 min-h-screen transition-colors duration-300 antialiased selection:bg-cyan-500 selection:text-white relative">
  ...
  <header class="sticky top-0 z-40 glass-nav transition-colors duration-300">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
      ...
      <!-- Navigation Links (Desktop) with Icons -->
  ...
  <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 space-y-16 relative z-10">
        ...
        <div class="flex flex-col lg:flex-row items-center lg:items-start gap-8 sm:gap-12 relative z-10">
          ...
          <div class="flex-1 text-center lg:text-left space-y-4">
            ...
            <div class="space-y-1.5">
              ...
              <h1 class="text-3xl sm:text-5xl font-extrabold tracking-tight text-white flex flex-wrap items-center justify-center lg:justify-start gap-2">
                <span id="hero-name">Howard Liao, Ph.D.</span>
                <span class="text-2xl sm:text-3xl font-semibold text-slate-400" id="hero-name-zh">(廖倫豪 博士)</span>
              </h1>
              <h2 class="text-xl sm:text-2xl font-bold text-gradient flex items-center justify-center lg:justify-start gap-2" data-i18n="hero.title">
    ...
    <section id="kpi" class="space-y-4">
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4">
        ...
        <div class="glass-card rounded-2xl p-4 text-center border border-slate-800 hover:border-blue-500/60 transition-all group hover:-translate-y-1">
          ...
          <div class="text-2xl sm:text-3xl font-extrabold text-blue-400 counter" data-target="-30" data-suffix="%">-30%</div>
    ...
    <!-- INTERACTIVE SECTION: SECURITY GOVERNANCE RADAR -->
    <section id="radar" class="space-y-6">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
        ...
        <!-- Dynamic Dimension Cards (6 Cards) with Icons -->
    ...
    <!-- SECTION: CORE COMPETENCIES (8 DOMAINS WITH ICONS) -->
    ...
    <!-- SECTION: PROFESSIONAL EXPERIENCE (7 MILESTONES WITH EXPANDABLE SCOPES & ICONS) -->
  ...
  <footer class="border-t border-slate-800 bg-obsidian-950/90 backdrop-blur-md py-10 mt-20 text-center text-xs text-slate-500 space-y-3 relative z-10">
    <div class="flex flex-wrap justify-center items-center gap-4 text-slate-400">
      <a href="https://howardliao.github.io/Howard_CISO/" target="_blank" class="hover:text-cyan-400 transition-colors flex items-center gap-1">
  ...
  <script>
    ...
    function setLang(lang) {{
      ...
      ['en', 'zh', 'ja'].forEach(l => {{
        ...
        if (l === lang) {{
          btn.className = "px-2 py-1 rounded transition-all bg-cyan-600 text-white shadow-sm font-bold";
        }} else {{
      ...
      // Update Profile Paragraphs with Icons
    ...
    function filterSpeaking(filter) {{
      ...
      document.querySelectorAll('.speak-filter-btn').forEach(btn => {{
        if (btn.getAttribute('data-filter') === filter) {{
          btn.className = "speak-filter-btn px-3.5 py-1.5 rounded-xl bg-cyan-600 text-white font-semibold shadow-sm flex items-center gap-1.5";
        }} else {{
          btn.className = "speak-filter-btn px-3.5 py-1.5 rounded-xl bg-slate-800 text-slate-300 hover:text-white font-semibold flex items-center gap-1.5";
        }}
      }});
          ...
          <div class="space-y-3">
            ...
            <div>
              <div class="flex items-center gap-2 mb-1.5">
                <span class="text-[10px] font-bold uppercase tracking-wider px-2.5 py-0.5 rounded-full flex items-center gap-1 ${{
                  ...
                  ${{item.type === 'keynote' ? '🎤 Keynote' : item.type === 'paper' ? '📜 Paper' : item.type === 'media' ? '📰 Media' : '🏆 Award/CSR'}}
                </span>
...
print(f"Successfully generated all heading icons into: {target_file}")
