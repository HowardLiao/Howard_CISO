        ...
        exp: {
          ...
          items: [
            ...
            },
            {
              ...
              groupNote: "Kuang Nan Group / Fengchen Group – Aiju Computer (Headquartered in Taichung with offices in Taipei, Shenzhen, Shanghai, Zhangjiagang ) Publicly Listed Company",
      ...
      zh: {
        ...
        exp: {
          ...
          items: [
            ...
            {
              role: "資訊部經理 / 數位轉型負責人",
              groupNote: "光男集團 / 峰晨集團 – 艾鉅電腦 (總部在台中，並在台北、深圳、上海、張家港設有據點 ) 上市櫃公司",
        ...
        exp: {
          ...
          items: [
            ...
            },
            {
              ...
              groupNote: "Kuang Nan Group / Fengchen Group – Aiju Computer (台中本社、台北・深セン・上海・張家港拠点 ) 上場企業",
